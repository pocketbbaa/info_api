...
public class ImageUtils {
    ...
    public static void main(String[] args) {
        ...
        String result = null;
        // 给图片添加图片水印
        result = ImageUtils.markImageByMoreIcon(icon, source, output, imageName, imageType, degree);
        // result = MarkImageUtils.markImageBySingleIcon(icon, source, output,
        // imageName, imageType, degree);
        // //给图片添加文字水印
        // result =
        // MarkImageUtils.markImageByMoreText(source,output,imageName,imageType,Color.red,text,degree);
        // result =
        // MarkImageUtils.markImageBySingleText(source,output,imageName,imageType,Color.red,text,degree);
        // //给图片打马赛克
        // result =
        // MarkImageUtils.markImageByMosaic(source,output,imageName,imageType,size);
     ...
     * 
     * @param icon
     *            水印图片路径（如：F:/images/icon.png）
     * @param source
     *            没有加水印的图片路径（如：F:/images/6.jpg）
     * @param output
     *            加水印后的图片路径（如：F:/images/）
     * @param imageName
     *            图片名称（如：11111）
     * @param imageType
     *            图片类型（如：jpg）
     ...
     *            水印图片旋转角度，为null表示不旋转
     */
    public static String markImageByMoreIcon(String icon, String source, String output, String imageName,
     ...
     *            水印图片旋转角度，为null表示不旋转
     */
    public static String markImageBySingleIcon(String icon, String source, String output, String imageName,
            String imageType, Integer degree) {
        String result = "添加图片水印出错";
        try {
            File file = new File(source);
     ...
     * 
     * @param source
     *            需要添加水印的图片路径（如：F:/images/6.jpg）
     * @param outPut
     *            添加水印后图片输出路径（如：F:/images/）
     * @param imageName
     *            图片名称（如：11111）
     * @param imageType
     *            图片类型（如：jpg）
     ...
     *            水印文字旋转角度，为null表示不旋转
     */
    public static String markImageByMoreText(String source, String output, String imageName, String imageType,
     ...
     *            水印文字旋转角度，为null表示不旋转
     */
    public static String markImageBySingleText(String source, String output, String imageName, String imageType,
            Color color, String word, Integer degree) {
        String result = "添加文字水印出错";
        try {
            // 读取原图片信息
     ...
     * 
     * @param source
     *            原图片路径（如：F:/images/6.jpg）
     * @param output
     *            打马赛克后，图片保存的路径（如：F:/images/）
     * @param imageName
     *            图片名称（如：11111）
     * @param imageType
     *            图片类型（如：jpg）
